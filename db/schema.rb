...
ActiveRecord::Schema.define(version: 2020_07_23_142125) do
  ...
  create_table "rescues", force: :cascade do |t|
    ...
    t.index ["receiving_user_id_id"], name: "index_rescues_on_receiving_user_id_id"
